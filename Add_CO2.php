...
$sql = "UPDATE `co_add2` SET `QoneA`='$QoneA',`QoneB`='$QoneB',`QoneC`='$QoneC',`QoneD`='$QoneD',`QoneE`='$QoneE',`QoneF`='$QoneF',`QtwoA`='$QtwoA',`QtwoB`='$QtwoB',`QtwoC`='$QtwoC',`QtwoD`='$QtwoD',`QtwoE`='$QtwoE' WHERE id=2 ";
