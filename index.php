...
<body>
<div class="main">
		<h1>OBE Registration and Login </h1>
	 <div class="sap_tabs">	
...
if($row>0)
{
	...
	$msg=mysqli_query($conn,"insert into users(fname,lname,email,password,contactno) values('$fname','$lname','$email','$enc_password','$contact')");
