<?php
										...
										$showquery = "select * from tblstudents2 where id={$ids}";
										...
										$query = " update tblstudents2 set id=$idupdate ,f_name='$f_name',En_no='$En_no',QoneA='$QoneA',QoneB='$QoneB',QoneC='$QoneC',QoneD='$QoneD',QoneE='$QoneE',QoneF='$QoneF',QtwoA='$QtwoA',QtwoB='$QtwoB',QtwoC='$QtwoC',QtwoD='$QtwoD',QtwoE='$QtwoE' where id=$idupdate ";
