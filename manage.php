...
?></b></td>
     <td style="text-align: center"><b><?php $sql = "SELECT AVG(QoneB)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QoneB)'];
}
?></b></td>
      <td style="text-align: center"><b><?php $sql = "SELECT AVG(QoneC)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QoneC)'];
}
?></b></td>
       <td style="text-align: center"><b><?php $sql = "SELECT AVG(QoneD)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QoneD)'];
}
?></b></td>
        <td style="text-align: center"><b><?php $sql = "SELECT AVG(QoneE)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QoneE)'];
}
?></b></td>
         <td style="text-align: center"><b><?php $sql = "SELECT AVG(QoneF)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QoneF)'];
}
?></b></td>
          <td style="text-align: center"><b><?php $sql = "SELECT AVG(QtwoA)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QtwoA)'];
}
?></b></td>
           <td style="text-align: center"><b><?php $sql = "SELECT AVG(QtwoB)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QtwoB)'];
}
?></b></td>
            <td style="text-align: center"><b><?php $sql = "SELECT AVG(QtwoC)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QtwoC)'];
}
?></b></td>
             <td style="text-align: center"><b><?php $sql = "SELECT AVG(QtwoD)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QtwoD)'];
}
?></b></td>
              <td style="text-align: center"><b><?php $sql = "SELECT AVG(QtwoE)FROM tblstudents"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $row['AVG(QtwoE)'];
}
?></b></td>
 ...
 <!-- <div class="form-group">
													...
													<div class="form-group">
                                                        <div class="col-sm-10">
														<a class="Add data" href="add-students.php">
                                                            <button align="left" type="submit" name="submit" class="btn btn-primary">Add data</button>
                                                        </div>
                                                    </div>
													
													<div class="container">
  <div class="vertical-center">
														<a class="Add CO" href="CO_Analysis.php">
													  ...
													  <div class="topnav-right">
                                                        <div class="col-sm-10">
														<a class="Analyze" href="">
														<p align="right">
                                                            <button type="submit" align="right" name="submit" class="btn btn-primary">Analyze</button>
                                                        </div>
                                                    </div>
