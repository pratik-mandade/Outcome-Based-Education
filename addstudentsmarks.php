...
$sql = "INSERT INTO `tblstudents` (`f_name`, `En_no`, `s_class`, `QoneA`, `QoneB`, `QoneC`,`QoneD`, `QoneE`, `QoneF`,`QtwoA`, `QtwoB`, `QtwoC`,`QtwoD`, `QtwoE`) VALUES ('$f_name', '$En_no','$s_class','$QoneA','$QoneB','$QoneC','$QoneD','$QoneE','$QoneF','$QtwoA','$QtwoB','$QtwoC','$QtwoD','$QtwoE')";
...
<div class="container">
    ...
    <div id="left">Q2.E<input type="text" name="QtwoE" class="col-sm-2" value=" "></div>
													...
													<div class="container">
														...
														<a class="Add CO" href="manage-students.php">
