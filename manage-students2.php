...
?></b></td>
  ...
  <tr>
    ...
    <th><input type="text" class="col-sm-7" name= "ANQoneA" value="Q1.A"readonly></th>
	...
	<?php
													...
													<tr>
															...
															<td> <input type="text" class="col-sm-5" name= "COQoneA" value="<?php echo $co1=$res['QoneA']; ?><?php $sql="Update co_attainment2 set course_outcome=$co1 where id='Q1.A'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneB" value="<?php echo $co2=$res['QoneB']; ?><?php $sql="Update co_attainment2 set course_outcome=$co2 where id='Q1.B'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneC" value="<?php echo $co3=$res['QoneC']; ?><?php $sql="Update co_attainment2 set course_outcome=$co3 where id='Q1.C'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneD" value="<?php echo $co4=$res['QoneD']; ?><?php $sql="Update co_attainment2 set course_outcome=$co4 where id='Q1.D'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneE" value="<?php echo $co5=$res['QoneE']; ?><?php $sql="Update co_attainment2 set course_outcome=$co5 where id='Q1.E'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneF" value="<?php echo $co6=$res['QoneF']; ?><?php $sql="Update co_attainment2 set course_outcome=$co6 where id='Q1.F'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQtwoA" value="<?php echo $co7=$res['QtwoA']; ?><?php $sql="Update co_attainment2 set course_outcome=$co7 where id='Q2.A'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQtwoB" value="<?php echo $co8=$res['QtwoB']; ?><?php $sql="Update co_attainment2 set course_outcome=$co8 where id='Q2.B'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQtwoC" value="<?php echo $co9=$res['QtwoC']; ?><?php $sql="Update co_attainment2 set course_outcome=$co9 where id='Q2.C'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneD" value="<?php echo $co10=$res['QtwoD']; ?><?php $sql="Update co_attainment2 set course_outcome=$co10 where id='Q2.D'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
															<td> <input type="text" class="col-sm-5" name= "COQoneE" value="<?php echo $co11=$res['QtwoE']; ?><?php $sql="Update co_attainment2 set course_outcome=$co11 where id='Q2.E'"; $rs = mysqli_query($conn, $sql);?>" readonly></td>
  ...
  <!--update into co_attainment set maximum_marks=$res['QoneA'] where id='Q1.A';-->
    ...
    <th>Average marks</th>
  <td>
<input type="text" class="col-sm-7" name="AVQoneA" value="<?php $sql = " SELECT AVG(QoneA)FROM tblstudents2";
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg1=$row['AVG(QoneA)'];
	
}?><?php $sql="Update co_attainment2 set average_marks=$avg1 where id='Q1.A'"; $rs = mysqli_query($conn, $sql);?>"readonly>	
</td>
...
}?><?php $sql="Update co_attainment2 set average_marks=$avg2 where id='Q1.B'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
      <td>
	  <input type="text" class="col-sm-7" name= "AVQoneC" value="<?php $sql = "SELECT AVG(QoneC)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg3=$row['AVG(QoneC)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg3 where id='Q1.C'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
       <td>
	   <input type="text" class="col-sm-7" name= "AVQoneD" value="<?php $sql = "SELECT AVG(QoneD)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg4=$row['AVG(QoneD)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg4 where id='Q1.D'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
        <td>
		 <input type="text" class="col-sm-7" name= "AVQoneE" value="<?php $sql = "SELECT AVG(QoneE)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg5=$row['AVG(QoneE)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg5 where id='Q1.E'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
         <td> <input type="text" class="col-sm-7" name= "AVQoneF" value="<?php $sql = "SELECT AVG(QoneF)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg6=$row['AVG(QoneF)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg6 where id='Q1.F'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
          <td>
		   <input type="text" class="col-sm-7" name= "AVQtwoA" value="<?php $sql = "SELECT AVG(QtwoA)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg7=$row['AVG(QtwoA)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg7 where id='Q2.A'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
           <td> <input type="text" class="col-sm-7" name= "AVQtwoB" value="<?php $sql = "SELECT AVG(QtwoB)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg8=$row['AVG(QtwoB)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg8 where id='Q2.B'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
            <td> <input type="text" class="col-sm-7" name= "AVQtwoC" value="<?php $sql = "SELECT AVG(QtwoC)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg9=$row['AVG(QtwoC)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg9 where id='Q2.C'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
             <td> <input type="text" class="col-sm-7" name= "AVQtwoD" value="<?php $sql = "SELECT AVG(QtwoD)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg10=$row['AVG(QtwoD)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg10 where id='Q2.D'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
              <td> <input type="text" class="col-sm-7" name= "AVQtwoE" value="<?php $sql = "SELECT AVG(QtwoE)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
	echo $avg11=$row['AVG(QtwoE)'];
}?><?php $sql="Update co_attainment2 set average_marks=$avg11 where id='Q2.E'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
  </tr>
  
  
    <tr>
    <th>CO Attainment in %</th>
<td> <input type="text" class="col-sm-6" name= "ATQoneA" value="<?php $sql = "SELECT AVG(QoneA)FROM tblstudents2"; 
$result = $conn->query($sql); 
while($row = mysqli_fetch_array($result)){
echo $coa1=$row['AVG(QoneA)']/2*100;
		
}?><?php $sql="Update co_attainment2 set co_att=$coa1 where id='Q1.A'"; $rs = mysqli_query($conn, $sql);?>"readonly>
</td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa2 where id='Q1.B'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa3 where id='Q1.C'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa4 where id='Q1.D'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa5 where id='Q1.E'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa6 where id='Q1.F'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa7 where id='Q2.A'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa8 where id='Q2.B'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa9 where id='Q2.C'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa10 where id='Q2.D'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
...
}?><?php $sql="Update co_attainment2 set co_att=$coa11 where id='Q2.E'"; $rs = mysqli_query($conn, $sql);?>"readonly></td>
  </tr>
</table>
                        ...
                        <th>CO 6</th>
                            <th>CO 7</th>
                            	<th>CO 8</th>
														...
														<tr>
														<th>Attainment</th>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=1"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=2"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=3"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=4"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=5"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=6"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=7"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
														<td><?php $sql = "Select AVG(co_att) from co_attainment2 where course_outcome=8"; 
															$result = $conn->query($sql); 
															while($row = mysqli_fetch_array($result)){
																echo $row['AVG(co_att)'];
															}?></td>
